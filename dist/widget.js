...
`;function Xt(e,n,r){let t=document.createElement("section");t.className="spotify-settings-card";let c=document.createElement("header");c.className="spotify-settings-card-header";let l=document.createElement("h3");l.textContent="Spotify Controls";let a=document.createElement("span");a.className="spotify-status",c.appendChild(l),c.appendChild(a);let u=document.createElement("div");u.className="spotify-settings-card-body";let d=document.createElement("label");d.className="spotify-settings-label",d.textContent="Client ID";let p=document.createElement("input");p.className="spotify-input",p.type="text",p.placeholder="Spotify Client ID",d.appendChild(p);let y=document.createElement("label");y.className="spotify-settings-label",y.textContent="Client Secret (optional)";let h=document.createElement("input");h.className="spotify-input",h.type="password",h.placeholder="Optional for PKCE apps",y.appendChild(h);let L=document.createElement("label");L.className="spotify-settings-label",L.textContent="Last.fm API Key";let w=document.createElement("input");w.className="spotify-input",w.type="password",w.placeholder="Last.fm API Key (for recommendations)",L.appendChild(w);let k=document.createElement("div");k.className="spotify-settings-row";let E=document.createElement("button");E.className="spotify-btn spotify-btn-primary",E.textContent="Save",E.style.fontSize="0.85em",E.style.padding="4px 12px",E.addEventListener("click",()=>{let Z=w.value.trim();if(!Z)return;e({type:"save_lastfm_key",apiKey:Z})}),k.appendChild(E);let x=document.createElement("label");x.className="spotify-settings-label",x.style.display="block";let U=document.createElement("div");U.className="spotify-settings-row",U.style.alignItems="center",U.style.gap="10px";let b=document.createElement("input");b.type="checkbox",b.style.margin="0";let M=document.createElement("div");M.style.display="grid",M.style.gap="2px";let V=document.createElement("span");V.textContent="Attach Spotify preview audio";let W=document.createElement("span");W.style.cssText="font-size:0.8em;opacity:0.68",W.textContent="For eligible multimodal models only. Downloads Spotify's 30-second preview and attaches it to the latest user turn.",M.appendChild(V),M.appendChild(W),U.appendChild(b),U.appendChild(M),x.appendChild(U);let se=document.createElement("label");se.className="spotify-settings-label",se.textContent="Redirect URI";let ie=document.createElement("div");ie.className="spotify-settings-row",ie.style.gap="6px";let P=document.createElement("input");P.className="spotify-input",P.type="text",P.readOnly=!0,P.placeholder="Loading...",P.style.flex="1",P.style.cursor="text",P.style.userSelect="all";let q=document.createElement("button");q.className="spotify-btn spotify-btn-primary",q.textContent="Copy",q.style.fontSize="0.85em",q.style.padding="4px 12px",q.style.flexShrink="0",q.addEventListener("click",()=>{if(!P.value)return;navigator.clipboard.writeText(P.value).then(()=>{let Z=q.textContent;q.textContent="Copied!",setTimeout(()=>{q.textContent=Z},1500)})}),ie.appendChild(P),ie.appendChild(q),se.appendChild(ie);let F=document.createElement("div");F.style.cssText="font-size:0.8em;opacity:0.6;margin-top:2px",F.textContent="Add this loopback URL in Spotify. If it fails on another device, paste the failed callback URL below.",se.appendChild(F);let H=document.createElement("label");H.className="spotify-settings-label",H.textContent="Finish from another device";let g=document.createElement("div");g.className="spotify-settings-row",g.style.gap="6px";let z=document.createElement("input");z.className="spotify-input",z.type="text",z.placeholder="Paste the 127.0.0.1 callback URL here",z.style.flex="1";let _=document.createElement("button");_.className="spotify-btn spotify-btn-primary",_.textContent="Finish",_.style.fontSize="0.85em",_.style.padding="4px 12px",_.style.flexShrink="0",_.addEventListener("click",()=>{let Z=z.value.trim();if(!Z)return;e({type:"complete_auth_callback",callbackUrl:Z})}),g.appendChild(z),g.appendChild(_),H.appendChild(g);let j=document.createElement("div");j.className="spotify-settings-row";let I=document.createElement("button");I.className="spotify-btn spotify-btn-primary",I.textContent="Connect",j.appendChild(I),u.appendChild(d),u.appendChild(y),u.appendChild(se),u.appendChild(H),u.appendChild(L),u.appendChild(k),u.appendChild(x),u.appendChild(j),t.appendChild(c),t.appendChild(u);let G=!1;function ge(Z,ve,J,A,v,S){if(G=Z,ve)p.value=ve;if(v){let O=n();P.value=O+v}if(Z)p.disabled=!0,h.disabled=!0,h.value="",h.placeholder="••••••••",I.textContent="Disconnect",I.className="spotify-btn spotify-btn-danger",I.disabled=!1,a.innerHTML='<span class="spotify-status-dot connected"></span>Connected';else{if(p.disabled=!1,h.disabled=!1,J)h.placeholder="Saved (re-enter to change)";else h.placeholder="Optional for PKCE apps";I.textContent="Connect",I.className="spotify-btn spotify-btn-primary",I.disabled=!1,a.innerHTML='<span class="spotify-status-dot disconnected"></span>Not connected'}if(A)w.value="",w.placeholder="Saved (re-enter to change)";else w.placeholder="Last.fm API Key (for recommendations)";b.checked=!!S}function he(){I.textContent="Connecting...",I.disabled=!0,I.className="spotify-btn spotify-btn-primary",a.innerHTML='<span class="spotify-status-dot disconnected"></span>Waiting for authorization...'}return I.addEventListener("click",()=>{if(G)e({type:"disconnect"});else{let Z=p.value.trim(),ve=h.value.trim();if(!Z){a.innerHTML='<span class="spotify-status-dot disconnected"></span><span style="color:#e74c3c">Client ID is required</span>';return}he(),e({type:"connect",clientId:Z,clientSecret:ve||void 0,serverBaseUrl:n()})}}),b.addEventListener("change",async()=>{let Z=b.checked;b.disabled=!0;try{b.checked=await r(Z)}finally{b.disabled=!1}}),ge(!1,""),{root:t,update:ge,setConnecting:he,destroy(){t.remove()}}}function Ye(e,n){if(!e)return null;if(!n)return e;try{let r=new URL(e);return r.searchParams.set("track",n),r.toString()}catch{let r=e.includes("?")?"&":"?";return`${e}${r}track=${encodeURIComponent(n)}`}}function je(e){let n=document.createElement("div");n.className=`${e} spotify-crossfade-art`,n.style.display="none";let r=document.createElement("img"),t=document.createElement("img");r.className="spotify-crossfade-img",t.className="spotify-crossfade-img",r.alt="",t.alt="",r.loading="eager",t.loading="eager",r.decoding="async",t.decoding="async",r.style.visibility="hidden",t.style.visibility="hidden",r.style.opacity="1",t.style.opacity="0",n.appendChild(r),n.appendChild(t);let c=null,l=r,a=t,u=!1;function d(h){h.onload=null,h.onerror=null,h.removeAttribute("src"),h.style.visibility="hidden"}function p(){n.style.display="none",l.style.opacity="1",a.style.opacity="0"}function y(h){if(h===c)return;if(c=h,!h){d(l),d(a),u=!1,p();return}if(!u){if(n.style.display="",l.onload=()=>{u=!0,l.style.visibility="visible"},l.onerror=()=>{c=null,d(l),p()},l.src=h,l.complete&&l.naturalWidth>0)u=!0,l.style.visibility="visible";return}if(n.style.display="",a.onload=()=>{a.style.visibility="visible",a.style.opacity="1",l.style.opacity="0";let L=l;l=a,a=L},a.onerror=()=>{c=null,d(a),a.style.opacity="0"},a.src=h,a.complete&&a.naturalWidth>0){a.style.visibility="visible",a.style.opacity="1",l.style.opacity="0";let L=l;l=a,a=L}}return{el:n,setUrl:y,destroy(){n.remove()}}}function ct(e,n){let r=!1;function t(x){if(r===x)return;r=x,n.onInteractChange?.(x)}function c(x){if(n.stopPropagation)x.stopPropagation()}function l(){return Number.parseInt(e.value,10)}let a=(x)=>{c(x),t(!0)},u=(x)=>{c(x)},d=(x)=>{c(x),t(!1)},p=(x)=>{c(x),t(!0)},y=(x)=>{c(x)},h=(x)=>{c(x),t(!1)},L=(x)=>{c(x)},w=(x)=>{c(x),t(!0),n.onPreview?.(l())},k=(x)=>{c(x);let U=l();n.onPreview?.(U),n.onCommit(U),t(!1)},E=()=>{t(!1)};return e.addEventListener("pointerdown",a),e.addEventListener("pointermove",u),e.addEventListener("pointerup",d),e.addEventListener("touchstart",p,{passive:!0}),e.addEventListener("touchmove",y,{passive:!0}),e.addEventListener("touchend",h,{passive:!0}),e.addEventListener("click",L),e.addEventListener("input",w),e.addEventListener("change",k),e.addEventListener("blur",E),e.addEventListener("pointercancel",E),e.addEventListener("lostpointercapture",E),()=>{e.removeEventListener("pointerdown",a),e.removeEventListener("pointermove",u),e.removeEventListener("pointerup",d),e.removeEventListener("touchstart",p),e.removeEventListener("touchmove",y),e.removeEventListener("touchend",h),e.removeEventListener("click",L),e.removeEventListener("input",w),e.removeEventListener("change",k),e.removeEventListener("blur",E),e.removeEventListener("pointercancel",E),e.removeEventListener("lostpointercapture",E)}}function pt(e,n){let r=!1,t=null,c=0;function l(b){if(r===b)return;r=b,n.onInteractChange?.(b)}function a(b){if(n.stopPropagation)b.stopPropagation()}function u(b){let M=n.getMaxValue();if(!Number.isFinite(M)||M<=0)return null;let V=e.getBoundingClientRect();if(V.width<=0)return null;let W=Math.max(0,Math.min(1,(b-V.left)/V.width));return Math.round(W*M)}function d(b){let M=u(b);if(M===null)return null;return c=M,n.onPreview(M),M}function p(b){if(t!==null&&e.hasPointerCapture(t))e.releasePointerCapture(t);if(t=null,b)n.onCommit(c);l(!1)}let y=(b)=>{if(a(b),b.button!==0)return;if(d(b.clientX)===null)return;t=b.pointerId,l(!0);try{e.setPointerCapture(b.pointerId)}catch{}},h=(b)=>{if(a(b),b.pointerId!==t)return;d(b.clientX)},L=(b)=>{if(a(b),b.pointerId!==t)return;d(b.clientX),p(!0)},w=(b)=>{if(a(b),b.pointerId!==t)return;p(!1)},k=(b)=>{a(b),b.preventDefault()},E=(b)=>{a(b)},x=(b)=>{a(b)},U=(b)=>{a(b)};return e.addEventListener("pointerdown",y),e.addEventListener("pointermove",h),e.addEventListener("pointerup",L),e.addEventListener("pointercancel",w),e.addEventListener("click",k),e.addEventListener("touchstart",E,{passive:!0}),e.addEventListener("touchmove",x,{passive:!0}),e.addEventListener("touchend",U,{passive:!0}),()=>{e.removeEventListener("pointerdown",y),e.removeEventListener("pointermove",h),e.removeEventListener("pointerup",L),e.removeEventListener("pointercancel",w),e.removeEventListener("click",k),e.removeEventListener("touchstart",E),e.removeEventListener("touchmove",x),e.removeEventListener("touchend",U)}}function mt(e){let n=Math.floor(e/1000),r=Math.floor(n/60),t=n%60;return`${r}:${t.toString().padStart(2,"0")}`}function Kt(e){let n=document.createElement("div");n.className="spotify-section";let r=document.createElement("h3");r.className="spotify-section-title",r.textContent="Now Playing",n.appendChild(r);let t=document.createElement("div");t.className="spotify-now-playing";let c=je("spotify-album-art"),l=document.createElement("div");l.className="spotify-track-info";let a=document.createElement("div");a.className="spotify-track-name";let u=document.createElement("div");u.className="spotify-track-artist";let d=document.createElement("div");d.className="spotify-track-album";let p=document.createElement("div");p.className="spotify-track-device",l.appendChild(a),l.appendChild(u),l.appendChild(d),l.appendChild(p),t.appendChild(c.el),t.appendChild(l),n.appendChild(t);let y=document.createElement("div");y.className="spotify-progress-container";let h=document.createElement("span"),L=document.createElement("div");L.className="spotify-progress-bar";let w=document.createElement("div");w.className="spotify-progress-fill",L.appendChild(w);let k=document.createElement("span");y.appendChild(h),y.appendChild(L),y.appendChild(k),n.appendChild(y);let E=document.createElement("div");E.className="spotify-empty";let x=0,U=!1,b=0,M=0,V=!1,W=null;function se(){if(!V||!x){W=null;return}if(U){W=requestAnimationFrame(se);return}let g=Date.now()-M,z=Math.min(b+g,x),_=z/x*100;w.style.width=`${_}%`,h.textContent=mt(z),W=requestAnimationFrame(se)}function ie(){if(W!==null)return;W=requestAnimationFrame(se)}function P(){if(W!==null)cancelAnimationFrame(W),W=null}let q=pt(L,{getMaxValue:()=>x,onInteractChange(g){U=g},onPreview(g){let z=x>0?g/x*100:0;w.style.width=`${z}%`,h.textContent=mt(g)},onCommit(g){if(b=g,M=Date.now(),e(g),V)ie()}});function F(g){if(U=!1,c.setUrl(null),t.style.display="none",y.style.display="none",E.textContent=g,!n.contains(E))n.appendChild(E);x=0,w.style.width="0%",h.textContent=mt(0),k.textContent=mt(0),P()}function H(g,z){if(!z){F("Connect to Spotify to see playback");return}if(!g){F("No active playback — open Spotify on a device to get started");return}if(n.contains(E))n.removeChild(E);if(t.style.display="flex",y.style.display="flex",a.textContent=g.trackName,u.textContent=g.artistName,d.textContent=g.albumName,g.deviceName)p.textContent=`Playing on ${g.deviceName}`,p.style.display="";else p.style.display="none";if(x=g.durationMs,c.setUrl(Ye(g.albumArtUrl,g.trackUri)),V=g.isPlaying,!U)b=g.progressMs,M=Date.now();if(!U){let _=g.durationMs>0?g.progressMs/g.durationMs*100:0;w.style.width=`${_}%`,h.textContent=mt(g.progressMs)}if(k.textContent=mt(g.durationMs),g.isPlaying)ie();else P()}return H(null,!1),{root:n,update:H,destroy(){q(),P(),c.destroy(),n.remove()}}}var Ln='<svg viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"/></svg>',Tt='<svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>',kn='<svg viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>',Sn='<svg viewBox="0 0 24 24"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/></svg>',Mn='<svg viewBox="0 0 24 24"><path d="M10.59 9.17L5.41 4 4 5.41l5.17 5.17 1.42-1.41zM14.5 4l2.04 2.04L4 18.59 5.41 20 17.96 7.46 20 9.5V4h-5.5zm.33 9.41l-1.41 1.41 3.13 3.13L14.5 20H20v-5.5l-2.04 2.04-3.13-3.13z"/></svg>',zt='<svg viewBox="0 0 24 24"><path d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4z"/></svg>',Pn='<svg viewBox="0 0 24 24"><path d="M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4zm-4-2V9h-1l-2 1v1h1.5v4H13z"/></svg>',Nn='<svg viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"/></svg>';function Zt(e){let n=document.createElement("div");n.className="spotify-section";let r=document.createElement("h3");r.className="spotify-section-title",r.textContent="Controls",n.appendChild(r);let t=document.createElement("div");t.className="spotify-controls";function c(M,V=""){let W=document.createElement("button");return W.className=`spotify-ctrl-btn ${V}`.trim(),W.innerHTML=M,W}let l=c(Mn),a=c(Ln),u=c(Tt,"spotify-ctrl-btn-main"),d=c(Sn),p=c(zt);t.appendChild(l),t.appendChild(a),t.appendChild(u),t.appendChild(d),t.appendChild(p),n.appendChild(t);let y=document.createElement("div");y.className="spotify-volume-row";let h=document.createElement("span");h.innerHTML=Nn,h.style.cssText="width:16px;height:16px;display:flex;align-items:center;color:var(--lumiverse-text-muted)",h.querySelector("svg").style.cssText="width:16px;height:16px;fill:currentColor";let L=document.createElement("input");L.type="range",L.className="spotify-volume-slider",L.min="0",L.max="100",L.value="50",y.appendChild(h),y.appendChild(L),n.appendChild(y);let w=!1,k="off";a.addEventListener("click",()=>e({type:"previous"})),d.addEventListener("click",()=>e({type:"next"})),u.addEventListener("click",()=>{e({type:w?"pause":"play"})}),l.addEventListener("click",()=>{e({type:"toggle_shuffle"})}),p.addEventListener("click",()=>{e({type:"set_repeat",mode:k==="off"?"context":k==="context"?"track":"off"})});let E=!1,x=new Set,U=ct(L,{onInteractChange(M){E=M},onPreview(M){for(let V of x)V(M)},onCommit(M){e({type:"set_volume",percent:M})}});function b(M,V){if(!V){E=!1,n.style.display="none";return}if(n.style.display="",!M){E=!1,w=!1,u.innerHTML=Tt,l.classList.remove("active"),p.classList.remove("active"),p.innerHTML=zt;return}if(w=M.isPlaying,u.innerHTML=w?kn:Tt,l.classList.toggle("active",M.shuffleState),k=M.repeatState,p.classList.toggle("active",k!=="off"),p.innerHTML=k==="track"?Pn:zt,M.volume!==null&&!E)L.value=String(M.volume)}return{root:n,update:b,setVolume(M){L.value=String(M)},onVolumeChange(M){x.add(M)},destroy(){U(),x.clear(),n.remove()}}}function Qt(e){let n=document.createElement("div");n.className="spotify-section";let r=document.createElement("h3");r.className="spotify-section-title",r.textContent="Search",n.appendChild(r);let t=document.createElement("input");t.className="spotify-search-input",t.placeholder="Search for tracks...",n.appendChild(t);let c=document.createElement("div");c.className="spotify-search-results",n.appendChild(c);let l=null;t.addEventListener("input",()=>{if(l)clearTimeout(l);l=setTimeout(()=>{let u=t.value.trim();if(u.length>=2)e({type:"search",query:u});else c.innerHTML=""},400)});function a(u){if(c.innerHTML="",u.length===0){let d=document.createElement("div");d.className="spotify-empty",d.textContent="No results found",c.appendChild(d);return}for(let d of u){let p=document.createElement("div");if(p.className="spotify-search-item",d.albumArtUrl){let x=document.createElement("img");x.className="spotify-search-item-art",x.src=d.albumArtUrl,x.alt=d.album,p.appendChild(x)}let y=document.createElement("div");y.className="spotify-search-item-info";let h=document.createElement("div");h.className="spotify-search-item-name",h.textContent=d.name;let L=document.createElement("div");L.className="spotify-search-item-artist",L.textContent=`${d.artist} — ${d.album}`,y.appendChild(h),y.appendChild(L),p.appendChild(y);let w=document.createElement("div");w.className="spotify-search-item-actions";let k=document.createElement("button");k.className="spotify-search-item-btn",k.title="Play",k.innerHTML='<svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>',k.addEventListener("click",()=>{e({type:"play",trackUri:d.uri})});let E=document.createElement("button");E.className="spotify-search-item-btn",E.title="Add to queue",E.innerHTML='<svg viewBox="0 0 24 24"><path d="M15 6H3v2h12V6zm0 4H3v2h12v-2zM3 16h8v-2H3v2zM17 6v8.18c-.31-.11-.65-.18-1-.18-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3V8h3V6h-5z"/></svg>',E.addEventListener("click",()=>{e({type:"queue",trackUri:d.uri})}),w.appendChild(k),w.appendChild(E),p.appendChild(w),c.appendChild(p)}}return{root:n,setResults:a,destroy(){if(l)clearTimeout(l);n.remove()}}}function Tn(e){let n=/^(\d+):(\d{2})(?:\.(\d{1,3}))?$/.exec(e);if(!n)return null;let r=Number(n[1]),t=Number(n[2]),c=n[3]?Number(n[3].padEnd(3,"0")):0;if(!Number.isFinite(r)||!Number.isFinite(t)||t>59)return null;return r*60000+t*1000+c}function ut(e){if(!e)return[];let n=[];for(let t of e.split(/\r?\n/)){let c=[...t.matchAll(/\[([^\]]+)\]/g)].map((a)=>Tn(a[1])).filter((a)=>a!==null);if(c.length===0)continue;let l=t.replace(/(?:\[[^\]]+\])+/g,"").trim();for(let a of c)n.push({timeMs:a,text:l})}let r=[];for(let t of n.sort((c,l)=>c.timeMs-l.timeMs)){let c=r[r.length-1];if(c?.timeMs===t.timeMs)c.text=[c.text,t.text].filter(Boolean).join(`
`);else r.push({...t})}return r}function Jt(e){return e||"♪"}function en(e){return!e.includes(`
`)&&e.length>=36}function Lt(e){let n=[],r=null,t=-1;function c(){if(!r)return 0;if(!r.isPlaying)return r.progressMs;return Math.min(r.progressMs+Date.now()-r.updatedAt,r.durationMs||1/0)}function l(){if(n.length===0){let h=t!==-1;return t=-1,h}let d=c(),p=-1;for(let h=0;h<n.length;h++){if(n[h].timeMs>d)break;p=h}let y=p!==t;return t=p,y}function a(){let d=n.map((y,h)=>({...y,index:h,displayText:Jt(y.text),hasText:Boolean(y.text)}));if(!e||d.length<=e)return d;if(t<0)return d.slice(0,e);let p=Math.max(0,Math.min(t-Math.floor(e/2),d.length-e));return d.slice(p,p+e)}function u(){return n.map((d,p)=>({...d,index:p,displayText:Jt(d.text),hasText:Boolean(d.text)}))}return{clear(){n=[],r=null,t=-1},setLyrics(d){n=d,t=-1,l()},setPlayback(d){r=d},refreshActiveLineIndex:l,getActiveLineIndex(){return t},hasLyrics(){return n.length>0},getIndexedLines:u,getSnapshot(){return l(),{activeLineIndex:t,lines:a()}}}}var zn='<svg viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"/></svg>',tn='<svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>',In='<svg viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>',An='<svg viewBox="0 0 24 24"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/></svg>',_n='<svg viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"/></svg>',Un='<svg viewBox="0 0 24 24"><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/></svg>',Rn='<svg viewBox="0 0 24 24"><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/></svg>',Hn='<svg viewBox="0 0 24 24"><path d="M4 6h18V4H4c-1.1 0-2 .9-2 2v11H0v3h14v-3H4V6zm19 2h-6c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1zm-1 9h-4v-7h4v7z"/></svg>',nn="♪";function ft(e){let n=Math.floor(e/1000),r=Math.floor(n/60),t=n%60;return`${r}:${t.toString().padStart(2,"0")}`}var on=280,On=336,ye=8;function It(e){return e==="modern"?On:on}function Dn(e){if(!e)return[];return e.split(/\r?\n/).map((n)=>n.trim()).filter(Boolean).slice(0,5)}function rn(e,n,r){let t=document.createElement("div");t.className="spotify-mini-player",t.dataset.style="default",t.style.setProperty("--spotify-mini-player-width",`${on}px`);let c=je("spotify-mini-art"),l=document.createElement("div");l.className="spotify-mini-info";let a=document.createElement("div");a.className="spotify-mini-track";let u=document.createElement("div");u.className="spotify-mini-artist";let d=document.createElement("div");d.className="spotify-mini-album",l.appendChild(a),l.appendChild(u),l.appendChild(d);let p=document.createElement("button");p.className="spotify-mini-header-btn",p.innerHTML=Un,p.title="Open full player";let y=document.createElement("button");y.className="spotify-mini-header-btn",y.innerHTML=Rn,y.title="Collapse";let h=document.createElement("div");h.className="spotify-mini-header-btns",h.appendChild(p),h.appendChild(y);let L=document.createElement("div");L.className="spotify-mini-progress-row";let w=document.createElement("span");w.className="spotify-mini-time";let k=document.createElement("div");k.className="spotify-mini-progress-bar";let E=document.createElement("div");E.className="spotify-mini-progress-fill",k.appendChild(E);let x=document.createElement("span");x.className="spotify-mini-time",L.appendChild(w),L.appendChild(k),L.appendChild(x);let U=document.createElement("div");U.className="spotify-mini-controls";function b(s,C=""){let R=document.createElement("button");return R.className=`spotify-mini-btn ${C}`.trim(),R.innerHTML=s,R}let M=b(zn),V=b(tn,"spotify-mini-btn-main"),W=b(An);U.appendChild(M),U.appendChild(V),U.appendChild(W);let se=document.createElement("div");se.className="spotify-mini-volume-row";let ie=document.createElement("span");ie.className="spotify-mini-volume-icon",ie.innerHTML=_n;let P=document.createElement("input");P.type="range",P.className="spotify-mini-volume-slider",P.min="0",P.max="100",P.value="50",se.appendChild(ie),se.appendChild(P);let q=document.createElement("div");q.className="spotify-mini-device-row";let F=document.createElement("span");F.className="spotify-mini-device-icon",F.innerHTML=Hn;let H=document.createElement("span");H.className="spotify-mini-device-name";let g=document.createElement("button");g.className="spotify-mini-device-toggle",g.textContent="Switch",q.appendChild(F),q.appendChild(H),q.appendChild(g);let z=document.createElement("div");z.className="spotify-mini-device-list";let _=document.createElement("div");_.className="spotify-mini-empty",_.textContent="No active playback";let j=document.createElement("div");j.className="spotify-mini-header",j.appendChild(c.el),j.appendChild(l),j.appendChild(h),t.appendChild(j),t.appendChild(L);let I=document.createElement("div");I.className="spotify-mini-lyrics-section";let G=document.createElement("div");G.className="spotify-mini-lyrics-header",G.textContent="Lyrics";let ge=document.createElement("div");ge.className="spotify-mini-lyrics-body";let he=document.createElement("div");he.className="spotify-mini-lyrics-status";let Z=Array.from({length:5},()=>{let s=document.createElement("div");return s.className="spotify-mini-lyric-line",ge.appendChild(s),s});ge.appendChild(he),I.appendChild(G),I.appendChild(ge),t.appendChild(I),t.appendChild(U),t.appendChild(se),t.appendChild(q),t.appendChild(z),t.appendChild(_);let ve=!1,J=0,A=!1,v=0,S="default",O=null,D=!1,B=0,Q=0,ee=!1,ce=null,Re=null,me=[],Ce=[],Le=!1,de=!1,pe=-1,xe=!1,ze=!1,ue=!1,Me=null,Ge=null,Ve=null,fe=!1,we=!1;function ke(s,C=!1){he.className=C?"spotify-mini-lyrics-status spotify-mini-lyrics-status-loading":"spotify-mini-lyrics-status",he.textContent=s,he.style.display="";for(let R of Z)R.style.display="none",R.textContent="",R.className="spotify-mini-lyric-line"}function Je(){he.style.display="none";for(let s of Z)s.style.display=""}function He(){if(!ze||xe)return;ze=!1,K(!0)}function Oe(){if(ue)return;let s=Me,C=Ge,R=Ve;if(Me=null,Ge=null,Ve=null,s)_e(s.state,s.connected);if(C)ae(C);if(R!==null)ne(R);He()}function Xe(){if(!ee)return B;return Math.min(B+Math.max(0,Date.now()-Q),J||1/0)}function Ee(){if(me.length===0)return[];let C=[];if(pe<0)for(let R=0;R<Math.min(5,me.length);R++){let re=me[R];C.push({text:re.text||nn,index:R})}else{let R=Math.max(0,Math.min(pe-2,me.length-5));for(let re=0;re<5&&R+re<me.length;re++){let be=R+re,Ze=me[be];C.push({text:Ze.text||nn,index:be})}}while(C.length<5)C.push({text:" ",index:-1-C.length});return C}function We(){if(de){ke("Loading lyrics...",!0);return}if(Le){ke("♪ Instrumental");return}if(me.length>0){Je();let s=Ee();Z.forEach((C,R)=>{let re=s[R]??{text:" ",index:-1-R},be=pe<0?re.index:Math.abs(re.index-pe);if(C.className="spotify-mini-lyric-line",re.index===pe)C.classList.add("spotify-mini-lyric-line-active");else if(be===1)C.classList.add("spotify-mini-lyric-line-near");else if(be===2)C.classList.add("spotify-mini-lyric-line-mid");else C.classList.add("spotify-mini-lyric-line-far");C.textContent=re.text});return}if(Ce.length>0){Je(),Z.forEach((s,C)=>{s.className="spotify-mini-lyric-line spotify-mini-lyric-line-plain",s.textContent=Ce[C]??" "});return}ke("No lyrics available")}function K(s=!1){if(xe){ze=!0;return}if(S!=="modern"||me.length===0||!O||O.trackUri!==Re){if(s&&S==="modern")We();return}let C=Xe(),R=-1;for(let re=0;re<me.length;re++){if(me[re].timeMs>C)break;R=re}if(s||R!==pe)pe=R,We()}function X(s=!1){let C=S==="modern"&&D&&Boolean(O);if(I.style.display=C?"":"none",!C)return;if(xe){ze=!0;return}if(K(!0),s&&A)Ke()}function Fe(){if(ue||!A||!ee||!J){ce=null;return}if(fe){ce=requestAnimationFrame(Fe);return}let s=Date.now()-Q,C=Math.min(B+s,J),R=C/J*100;E.style.width=`${R}%`,w.textContent=ft(C),K(),ce=requestAnimationFrame(Fe)}function Pe(){if(ce!==null)return;ce=requestAnimationFrame(Fe)}function Ne(){if(ce!==null)cancelAnimationFrame(ce),ce=null}M.addEventListener("click",(s)=>{s.stopPropagation(),e({type:"previous"})}),W.addEventListener("click",(s)=>{s.stopPropagation(),e({type:"next"})}),V.addEventListener("click",(s)=>{s.stopPropagation(),e({type:ve?"pause":"play"})}),p.addEventListener("click",(s)=>{s.stopPropagation(),$e(),n()}),y.addEventListener("click",(s)=>{s.stopPropagation(),$e()});let De=pt(k,{getMaxValue:()=>J,onInteractChange(s){fe=s},onPreview(s){let C=J>0?s/J*100:0;E.style.width=`${C}%`,w.textContent=ft(s)},onCommit(s){if(O)O={...O,progressMs:s};if(B=s,Q=Date.now(),K(!0),e({type:"seek",positionMs:s}),A&&ee)Pe()}}),oe=new Set,Ie=ct(P,{onInteractChange(s){we=s},onPreview(s){for(let C of oe)C(s)},onCommit(s){e({type:"set_volume",percent:s})}}),Be=!1,Ae=null;g.addEventListener("click",(s)=>{if(s.stopPropagation(),Be)z.style.display="none",Be=!1;else e({type:"get_devices"}),z.innerHTML='<div class="spotify-mini-device-loading">Loading devices…</div>',z.style.display="flex",Be=!0}),t.addEventListener("pointerdown",(s)=>s.stopPropagation());function te(s){if(!t.contains(s.target))$e()}function Ke(){let{x:s,y:C,w:R,h:re}=r(),{innerWidth:be,innerHeight:Ze}=window,tt=It(S),Te=s+R/2-tt/2;Te=Math.max(ye,Math.min(Te,be-tt-ye)),t.style.left=`${Te}px`,t.style.top="0px",t.style.visibility="hidden",t.style.transform="scale(1)",t.style.display="flex";let Se=t.offsetHeight;v=Se,t.style.visibility="",t.style.transform="",t.style.display="";let Qe,qe=!1;if(C-Se-ye>=ye)Qe=C-Se-ye;else Qe=C+re+ye,qe=!0;Qe=Math.max(ye,Math.min(Qe,Ze-Se-ye)),t.style.left=`${Te}px`,t.style.top=`${Qe}px`;let at=s+R/2-Te,Mt=qe?-ye:Se+ye;t.style.transformOrigin=`${at}px ${Mt}px`}function et(){if(!A||!v)return;let{x:s,y:C,w:R,h:re}=r(),{innerWidth:be,innerHeight:Ze}=window,tt=It(S),Te=s+R/2-tt/2;Te=Math.max(ye,Math.min(Te,be-tt-ye));let Se,Qe=!1;if(C-v-ye>=ye)Se=C-v-ye;else Se=C+re+ye,Qe=!0;Se=Math.max(ye,Math.min(Se,Ze-v-ye)),t.style.left=`${Te}px`,t.style.top=`${Se}px`;let qe=s+R/2-Te,at=Qe?-ye:v+ye;t.style.transformOrigin=`${qe}px ${at}px`}function it(){if(!document.body.contains(t))document.body.appendChild(t);if(Ke(),t.classList.remove("open","closing"),t.offsetHeight,t.classList.add("open"),A=!0,ee)Pe();setTimeout(()=>document.addEventListener("click",te),0)}function $e(){if(!A)return;A=!1,document.removeEventListener("click",te),Ne(),Ke(),t.classList.remove("open"),t.classList.add("closing");let s=()=>{t.classList.remove("closing"),t.removeEventListener("transitionend",s)};t.addEventListener("transitionend",s),setTimeout(s,250)}function _e(s,C){if(O=s,D=C,ue){Me={state:s,connected:C};return}if(!C||!s){fe=!1,we=!1,c.setUrl(null),j.style.display="none",L.style.display="none",I.style.display="none",U.style.display="none",se.style.display="none",q.style.display="none",z.style.display="none",Be=!1,_.style.display="",_.textContent=!C?"Connect to Spotify in Settings":"No active playback",J=0,E.style.width="0%",w.textContent=ft(0),x.textContent=ft(0),Ne();return}if(j.style.display="",L.style.display="",U.style.display="",se.style.display="",_.style.display="none",s.deviceName)H.textContent=s.deviceName,q.style.display="",Ae=s.deviceId;else q.style.display="none";if(a.textContent=s.trackName,u.textContent=s.artistName,d.textContent=s.albumName,J=s.durationMs,c.setUrl(Ye(s.albumArtUrl,s.trackUri)),ve=s.isPlaying,ee=s.isPlaying,V.innerHTML=ve?In:tn,!fe){B=s.progressMs,Q=Date.now();let R=s.durationMs>0?s.progressMs/s.durationMs*100:0;E.style.width=`${R}%`,w.textContent=ft(s.progressMs)}if(x.textContent=ft(s.durationMs),s.volume!==null&&!we)P.value=String(s.volume);if(A&&ve)Pe();else Ne();X()}function Ue(s,C,R,re){Re=s,me=ut(R),Ce=Dn(C),Le=re,de=!1,pe=-1,X(!0)}function f(s){if(de=s,s)Re=O?.trackUri??null,me=[],Ce=[],Le=!1,pe=-1;X(!0)}function N(s){if(S=s,t.dataset.style=s,t.style.setProperty("--spotify-mini-player-width",`${It(s)}px`),X(!0),A)Ke()}function ae(s){if(ue){Ge=s;return}if(z.innerHTML="",s.length===0){z.innerHTML='<div class="spotify-mini-device-loading">No devices found</div>';return}for(let C of s){let R=document.createElement("div");if(R.className=`spotify-mini-device-item${C.isActive?" active":""}`,R.innerHTML=`<span class="spotify-mini-device-item-name">${C.name}</span><span class="spotify-mini-device-item-type">${C.type}</span>`,!C.isActive)R.addEventListener("click",(re)=>{re.stopPropagation(),e({type:"transfer_playback",deviceId:C.id}),z.style.display="none",Be=!1});z.appendChild(R)}}function ne(s){if(ue){Ve=s;return}P.value=String(s)}return{root:t,update:_e,updateLyrics:Ue,setLyricsLoading:f,setLyricsUpdateSuspended(s){if(xe=s,!s)He()},setUiSuspended(s){if(ue=s,xe=s,s){Ne();return}if(Oe(),A&&ee)Pe()},setStyle:N,setDevices:ae,setVolume:ne,onVolumeChange(s){oe.add(s)},toggle(){if(A)$e();else it()},hide:$e,isOpen:()=>A,reposition:et,destroy(){$e(),Ne(),De(),Ie(),oe.clear(),t.remove()}}}function kt(e){let n=null,r=null,t=null,c=0,l=!1,a=0;function u(w){let k=e.getBoundingClientRect(),E=w.getBoundingClientRect(),x=Math.max(0,e.scrollHeight-e.clientHeight);return Math.min(Math.max(e.scrollTop+(E.top+E.height/2)-(k.top+e.clientHeight/2),0),x)}function d(){if(n!==null)cancelAnimationFrame(n);n=null,r=null}function p(){d(),t=null,c=Date.now()}function y(){d(),t=null}function h(w){if(n=null,r===null||!r.isConnected||!e.isConnected){d();return}let k=Math.min(Math.max(w-a,0),100);a=w;let E=Math.max(0,e.scrollHeight-e.clientHeight),x=u(r),U=x-e.scrollTop;if(Math.abs(U)<0.5){t=x,e.scrollTop=x,d();return}let b=U*(1-Math.exp(-k/85)),M=1800*(k/1000),V=Math.abs(b)>M?Math.sign(b)*M:b,W=Math.min(Math.max(e.scrollTop+V,0),E);t=W,e.scrollTop=W,n=requestAnimationFrame(h)}e.addEventListener("wheel",p,{passive:!0}),e.addEventListener("touchmove",p,{passive:!0}),e.addEventListener("pointerdown",p,{passive:!0});function L(){if(n!==null||r!==null)return;if(t!==null&&Math.abs(e.scrollTop-t)<=1)return;p()}return e.addEventListener("scroll",L,{passive:!0}),{center(w,k){if(l)return;if(!k?.force&&Date.now()-c<=2500)return;if(window.matchMedia("(prefers-reduced-motion: reduce)").matches){d(),t=u(w),e.scrollTop=t;return}if(r=w,n===null)a=performance.now(),n=requestAnimationFrame(h)},suspend(w){if(l===w)return!1;if(l=w,l)y();return!0},cancel:y,destroy(){y(),e.removeEventListener("wheel",p),e.removeEventListener("touchmove",p),e.removeEventListener("pointerdown",p),e.removeEventListener("scroll",L)}}}var Bn='<svg viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z"/></svg>',sn='<svg viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>',qn='<svg viewBox="0 0 24 24"><path d="M6 19h4V5H6v14zm8-14v14h4V5h-4z"/></svg>',Vn='<svg viewBox="0 0 24 24"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/></svg>',Wn='<svg viewBox="0 0 24 24"><path d="M3 9v6h4l5 5V4L7 9H3zm13.5 3c0-1.77-1.02-3.29-2.5-4.03v8.05c1.48-.73 2.5-2.25 2.5-4.02z"/></svg>',Fn='<svg viewBox="0 0 24 24"><path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/></svg>',$n='<svg viewBox="0 0 24 24"><path d="M7.41 8.59L12 13.17l4.59-4.58L18 10l-6 6-6-6 1.41-1.41z"/></svg>',At='<svg viewBox="0 0 24 24"><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>',Yn=4000;function St(e){let n=Math.floor(e/1000),r=Math.floor(n/60),t=n%60;return`${r}:${t.toString().padStart(2,"0")}`}function jn(e){if(!e)return[];return e.split(/\r?\n/).map((n)=>n.trim()).filter(Boolean)}function yt(e){e.addEventListener("pointerdown",(n)=>n.stopPropagation()),e.addEventListener("pointermove",(n)=>n.stopPropagation()),e.addEventListener("pointerup",(n)=>n.stopPropagation()),e.addEventListener("touchstart",(n)=>n.stopPropagation(),{passive:!0}),e.addEventListener("touchmove",(n)=>n.stopPropagation(),{passive:!0}),e.addEventListener("touchend",(n)=>n.stopPropagation(),{passive:!0}),e.addEventListener("click",(n)=>n.stopPropagation())}function _t(e){let n=document.createElement("div");n.className=`${e} spotify-modern-widget-marquee`,n.dataset.marqueePhase="idle";let r=document.createElement("div");r.className=`${e}-content spotify-modern-widget-marquee-content`,n.appendChild(r);let t=null;function c(){if(t)clearTimeout(t),t=null;n.dataset.marqueePhase="idle",r.classList.remove("spotify-modern-widget-marquee-animate")}function l(u){if(n.dataset.marqueePhase="scrolling",r.classList.remove("spotify-modern-widget-marquee-animate"),u)r.offsetWidth;r.classList.add("spotify-modern-widget-marquee-animate")}function a(u){if(t)clearTimeout(t),t=null;n.dataset.marqueePhase="rest",r.classList.remove("spotify-modern-widget-marquee-animate"),t=setTimeout(()=>{t=null,l(u)},Yn)}return r.addEventListener("animationend",(u)=>{if(u.animationName!=="spotify-modern-marquee"||n.dataset.marqueePhase!=="scrolling")return;a(!0)}),{root:n,setText(u){r.textContent=u,n.setAttribute("aria-label",u)},refresh(u,d=!1){if(!u){n.dataset.overflow="false",c(),n.style.removeProperty("--spotify-modern-marquee-distance"),n.style.removeProperty("--spotify-modern-marquee-duration");return}let p=Math.ceil(r.scrollWidth-n.clientWidth);if(p<=6){n.dataset.overflow="false",c(),n.style.removeProperty("--spotify-modern-marquee-distance"),n.style.removeProperty("--spotify-modern-marquee-duration");return}n.dataset.overflow="true",n.style.setProperty("--spotify-modern-marquee-distance",`${p}px`),n.style.setProperty("--spotify-modern-marquee-duration",`${Math.max(8,Math.min(20,8+p/18))}s`);let y=t!==null,h=n.dataset.marqueePhase==="scrolling";if(d||!y&&!h)a(d)}}}function an(e,n,r){let t=document.createElement("div");t.className="spotify-modern-widget-player",t.dataset.expanded="false";let c=document.createElement("div");c.className="spotify-modern-widget-compact";let l=je("spotify-modern-widget-compact-art"),a=document.createElement("div");a.className="spotify-modern-widget-compact-fallback",a.innerHTML=At;let u=document.createElement("div");u.className="spotify-modern-widget-compact-overlay";let d=document.createElement("div");d.className="spotify-modern-widget-compact-status";let p=document.createElement("div");p.className="spotify-modern-widget-compact-progress",u.appendChild(d),c.appendChild(l.el),c.appendChild(a),c.appendChild(u),c.appendChild(p);let y=document.createElement("div");y.className="spotify-modern-widget-expanded";let h=document.createElement("div");h.className="spotify-modern-widget-header";let L=document.createElement("div");L.className="spotify-modern-widget-eyebrow",L.textContent="Now Playing";let w=document.createElement("div");w.className="spotify-modern-widget-header-buttons";let k=document.createElement("button");k.className="spotify-modern-widget-icon-btn",k.innerHTML=Fn,k.title="Open full player";let E=document.createElement("button");E.className="spotify-modern-widget-icon-btn",E.innerHTML=$n,E.title="Collapse",yt(k),yt(E),k.addEventListener("click",()=>n()),E.addEventListener("click",()=>r()),w.appendChild(k),w.appendChild(E),h.appendChild(L),h.appendChild(w);let x=document.createElement("div");x.className="spotify-modern-widget-hero";let U=je("spotify-modern-widget-art");U.el.title="Collapse";let b=document.createElement("div");b.className="spotify-modern-widget-art-fallback",b.innerHTML=At,b.title="Collapse",yt(U.el),yt(b),U.el.addEventListener("click",()=>r()),b.addEventListener("click",()=>r());let M=document.createElement("div");M.className="spotify-modern-widget-meta";let V=_t("spotify-modern-widget-track"),W=_t("spotify-modern-widget-artist"),se=_t("spotify-modern-widget-album");M.appendChild(V.root),M.appendChild(W.root),M.appendChild(se.root),x.appendChild(U.el),x.appendChild(b),x.appendChild(M);let ie=document.createElement("div");ie.className="spotify-modern-widget-progress-row";let P=document.createElement("span");P.className="spotify-modern-widget-time";let q=document.createElement("div");q.className="spotify-modern-widget-progress-bar";let F=document.createElement("div");F.className="spotify-modern-widget-progress-fill",q.appendChild(F);let H=document.createElement("span");H.className="spotify-modern-widget-time",ie.appendChild(P),ie.appendChild(q),ie.appendChild(H);let g=document.createElement("div");g.className="spotify-modern-widget-lyrics";let z=document.createElement("div");z.className="spotify-modern-widget-section-label",z.textContent="Lyrics";let _=document.createElement("div");_.className="spotify-modern-widget-lyrics-body";let j=document.createElement("div");j.className="spotify-modern-widget-lyrics-track",_.appendChild(j),g.appendChild(z),g.appendChild(_);let I=document.createElement("div");I.className="spotify-modern-widget-controls";let G=document.createElement("button");G.className="spotify-modern-widget-btn",G.innerHTML=Bn;let ge=document.createElement("button");ge.className="spotify-modern-widget-btn spotify-modern-widget-btn-main",ge.innerHTML=sn;let he=document.createElement("button");he.className="spotify-modern-widget-btn",he.innerHTML=Vn,I.appendChild(G),I.appendChild(ge),I.appendChild(he);let Z=document.createElement("div");Z.className="spotify-modern-widget-volume-row";let ve=document.createElement("span");ve.className="spotify-modern-widget-volume-icon",ve.innerHTML=Wn;let J=document.createElement("input");J.type="range",J.min="0",J.max="100",J.value="50",J.className="spotify-modern-widget-volume-slider",Z.appendChild(ve),Z.appendChild(J);let A=document.createElement("div");A.className="spotify-modern-widget-empty";let v=document.createElement("div");v.className="spotify-modern-widget-empty-icon",v.innerHTML=At;let S=document.createElement("div");S.className="spotify-modern-widget-empty-title",S.textContent="No music playing.";let O=document.createElement("div");O.className="spotify-modern-widget-empty-subtitle",O.textContent="Your speakers are enjoying a brief moment of mindfulness.",A.appendChild(v),A.appendChild(S),A.appendChild(O),y.appendChild(h),y.appendChild(x),y.appendChild(ie),y.appendChild(g),y.appendChild(I),y.appendChild(Z),y.appendChild(A),t.appendChild(c),t.appendChild(y),[q,G,ge,he,J].forEach((f)=>yt(f)),yt(_);let D=!1,B=null,Q=!1,ee=0,ce=0,Re=0,me=!1,Ce=null,Le=null,de=Lt(),pe=[],xe=!1,ze=!1,ue="",Me=[],Ge=kt(_),Ve="",fe=null,we=null,ke=!1,Je=!1,He=new ResizeObserver(()=>{Xe(!1)});He.observe(M),He.observe(t);let Oe=new ResizeObserver(()=>{if(!Q)return;De(!0)});Oe.observe(_);function Xe(f){requestAnimationFrame(()=>{V.refresh(Q,f),W.refresh(Q,f),se.refresh(Q,f)})}function Ee(f){if(fe)clearTimeout(fe);if(we)clearTimeout(we);Xe(f),fe=setTimeout(()=>Xe(f),180),we=setTimeout(()=>Xe(f),460)}function We(f){l.setUrl(f),a.style.display=f?"none":"flex"}function K(f){U.setUrl(f),b.style.display=f?"none":"flex"}function X(){if(!me)return ce;return Math.min(ce+Math.max(0,Date.now()-Re),ee||1/0)}function Fe(f,N){p.style.setProperty("--spotify-modern-widget-compact-progress",`${Math.max(0,Math.min(100,f))}%`),p.style.opacity=N?"1":"0"}function Pe(){Ge.cancel(),j.innerHTML="",_.scrollTop=0,Me=[]}function Ne(){Pe(),Me=de.getIndexedLines().map((N,ae)=>{let ne=document.createElement("div");return ne.className="spotify-modern-widget-lyric-line spotify-modern-widget-lyric-line-enter",ne.style.setProperty("--spotify-modern-lyric-enter-delay",`${Math.min(ae*22,110)}ms`),ne.textContent=N.displayText,j.appendChild(ne),ne})}function De(f=!1){if(!de.hasLyrics())return;let N=de.getActiveLineIndex(),ae=N>=0?Me[N]:Me[0];if(ae)Ge.center(ae,{force:f})}function oe(f=!0){let N=de.getActiveLineIndex();if(de.getIndexedLines().forEach((ne,s)=>{let C=Me[s];if(!C)return;if(C.className="spotify-modern-widget-lyric-line",ne.index===N)C.classList.add("active");else if(N>=0){let R=Math.abs(ne.index-N);if(R===1)C.classList.add("near");else if(R===2)C.classList.add("mid");else C.classList.add("far")}else C.classList.add("far")}),!f)return;De()}function Ie(){if(Pe(),!D||!B){ue="";let N=document.createElement("div");N.className="spotify-modern-widget-lyrics-status",N.textContent=D?"Start playback to see lyrics":"Connect Spotify to see lyrics",j.appendChild(N);return}if(ze){ue="loading";let N=document.createElement("div");N.className="spotify-modern-widget-lyrics-status spotify-modern-widget-lyrics-status-loading",N.textContent="Loading lyrics...",j.appendChild(N);return}if(xe){ue="instrumental";let N=document.createElement("div");N.className="spotify-modern-widget-lyrics-status",N.textContent="♪ Instrumental",j.appendChild(N);return}if(de.hasLyrics()&&B.trackUri===Le){ue=de.getIndexedLines().map((ae)=>`${ae.index}:${ae.text}`).join("|"),Ne(),oe(!1);return}if(pe.length>0){let N=pe.join("|"),ae=N!==ue;ue=N,pe.forEach((ne,s)=>{let C=document.createElement("div");if(C.className="spotify-modern-widget-lyric-line plain",ae)C.classList.add("spotify-modern-widget-lyric-line-enter"),C.style.setProperty("--spotify-modern-lyric-enter-delay",`${Math.min(s*20,100)}ms`);C.textContent=ne,j.appendChild(C)});return}ue="empty";let f=document.createElement("div");f.className="spotify-modern-widget-lyrics-status",f.textContent="No lyrics available",j.appendChild(f)}function Be(f=!1){if(!B||B.trackUri!==Le||!de.hasLyrics()){if(f)Ie();return}if(de.setPlayback({trackUri:B.trackUri,progressMs:X(),durationMs:ee,isPlaying:me,updatedAt:Date.now()}),f){Ie();return}if(de.refreshActiveLineIndex())oe(!0)}function Ae(){if(!B||!D||!me||!ee){Ce=null;return}if(ke){Ce=requestAnimationFrame(Ae);return}let f=X(),N=ee>0?f/ee*100:0;F.style.width=`${N}%`,Fe(N,!0),P.textContent=St(f),Be(),Ce=requestAnimationFrame(Ae)}function te(){if(Ce!==null)return;Ce=requestAnimationFrame(Ae)}function Ke(){if(Ce!==null)cancelAnimationFrame(Ce),Ce=null}G.addEventListener("click",()=>e({type:"previous"})),he.addEventListener("click",()=>e({type:"next"})),ge.addEventListener("click",()=>e({type:B?.isPlaying?"pause":"play"}));let et=pt(q,{getMaxValue:()=>ee,onInteractChange(f){ke=f},onPreview(f){let N=ee>0?f/ee*100:0;F.style.width=`${N}%`,Fe(N,ee>0),P.textContent=St(f)},onCommit(f){if(B)B={...B,progressMs:f};if(ce=f,Re=Date.now(),Be(!0),e({type:"seek",positionMs:f}),me)te()},stopPropagation:!0}),it=ct(J,{onInteractChange(f){Je=f},onCommit(f){e({type:"set_volume",percent:f})},stopPropagation:!0});function $e(f,N){if(B=f,D=N,t.dataset.empty=!f?"true":"false",!N||!f){ke=!1,Je=!1,L.textContent=N?"Standby":"Connect Spotify",d.textContent=N?"No playback":"Connect Spotify",A.style.display="grid",x.style.display="none",ie.style.display="none",g.style.display="none",I.style.display="none",Z.style.display="none",Fe(0,!1),We(null),K(null),de.setPlayback(null),Ve="",Ke(),Ie();return}L.textContent="Now Playing";let ae=Ye(f.albumArtUrl,f.trackUri);We(ae),K(ae),d.textContent=f.isPlaying?"Playing":"Paused";let ne=`${f.trackName}|${f.artistName}|${f.albumName}`,s=ne!==Ve;if(Ve=ne,V.setText(f.trackName),W.setText(f.artistName),se.setText(f.albumName),x.style.display="grid",ie.style.display="grid",g.style.display="grid",I.style.display="flex",Z.style.display="flex",A.style.display="none",ee=f.durationMs,me=f.isPlaying,de.setPlayback({trackUri:f.trackUri,progressMs:ke?ce:f.progressMs,durationMs:f.durationMs,isPlaying:f.isPlaying,updatedAt:ke?Re:Date.now()}),ge.innerHTML=f.isPlaying?qn:sn,!Je)J.value=String(f.volume??Number(J.value));if(!ke){ce=f.progressMs,Re=Date.now();let C=f.durationMs>0?f.progressMs/f.durationMs*100:0;F.style.width=`${C}%`,Fe(C,f.durationMs>0),P.textContent=St(f.progressMs)}if(H.textContent=St(f.durationMs),de.hasLyrics()&&f.trackUri===Le)if(Me.length===0)Ie();else Be();else if(j.childElementCount===0)Ie();if(Ee(s),f.isPlaying)te();else Ke()}function _e(f,N,ae,ne){Le=f;let s=ut(ae);de.setLyrics(s),pe=jn(N),xe=ne,ze=!1,Be(!0)}function Ue(f){if(ze=f,f)Le=B?.trackUri??null,de.clear(),pe=[],xe=!1;Ie()}return{root:t,update:$e,updateLyrics:_e,setLyricsLoading:Ue,setLyricsBlur(f){if(f)g.style.removeProperty("--spotify-lyrics-enter-blur");else g.style.setProperty("--spotify-lyrics-enter-blur","0px")},setAutoScrollSuspended(f){if(Ge.suspend(f)&&!f&&de.hasLyrics())oe(!0)},setCollapsedSize(f){t.style.setProperty("--spotify-modern-widget-collapsed-size",`${f}px`)},setExpanded(f){if(Q=f,t.dataset.expanded=String(f),Ee(!0),f)requestAnimationFrame(()=>De(!0))},isExpanded(){return Q},destroy(){if(Ke(),Ge.destroy(),et(),it(),fe)clearTimeout(fe);if(we)clearTimeout(we);He.disconnect(),Oe.disconnect(),l.destroy(),U.destroy(),t.remove()}}}var Gn=180,Xn=1400,Kn=1800;function ln(e,n,r,t){let c=["spotify-lyrics-line"];if(!r)c.push("spotify-lyrics-line-blank");if(e===n)c.push("spotify-lyrics-line-active");else if(e<n)c.push("spotify-lyrics-line-past");else c.push("spotify-lyrics-line-future");if(n>=0){let l=Math.abs(e-n);if(l>=1){let a=Math.min(l,4);if(c.push(`spotify-lyrics-line-tier-${a}`),t&&a>=2)c.push(`spotify-lyrics-line-blur-${a}`)}}return c.join(" ")}function dn(e){let n=document.createElement("div");n.className="spotify-section spotify-lyrics-section";let r=document.createElement("h3");r.className="spotify-section-title",r.textContent="Lyrics",n.appendChild(r);let t=document.createElement("div");t.className="spotify-lyrics-body",n.appendChild(t);let c=null,l=[],a=Lt(),u=kt(t),d=null,p=-1,y=!0,h=null,L=null,w=null,k=0;function E(){if(L)clearTimeout(L),L=null;t.classList.remove("spotify-lyrics-loading")}function x(){if(h)clearInterval(h),h=null}function U(){if(h||l.length===0)return;h=setInterval(W,200)}function b(){l.forEach((g)=>{g.el.className=ln(g.index,p,Boolean(g.text),y)})}function M(){if(y)n.style.removeProperty("--spotify-lyrics-enter-blur");else n.style.setProperty("--spotify-lyrics-enter-blur","0px")}function V(g,z=!1){p=g,b();let _=l.find((j)=>j.index===p);if(_)u.center(_.textEl,{force:z})}function W(){if(l.length===0)return;if(a.refreshActiveLineIndex())V(a.getActiveLineIndex())}function se(){x(),u.cancel(),E(),t.innerHTML="",t.className="spotify-lyrics-body",c=null,l=[],a.clear(),d=null,p=-1,w=null,k=0}function ie(g){if(E(),!g)return;if(g)x(),u.cancel(),t.innerHTML="",t.className="spotify-lyrics-body spotify-lyrics-loading",l=[],a.clear(),p=-1,L=setTimeout(()=>{if(L=null,!t.classList.contains("spotify-lyrics-loading"))return;let z=document.createElement("div");z.className="spotify-lyrics-status spotify-lyrics-status-loading",z.textContent="Loading lyrics...",t.appendChild(z)},Gn)}function P(g){E(),t.className="spotify-lyrics-body spotify-lyrics-has-content spotify-lyrics-synced",a.setLyrics(g);let z=a.getSnapshot();if(p=z.activeLineIndex,l=z.lines.map((_,j)=>{let I=document.createElement("div"),G=document.createElement("div");if(I.className=ln(_.index,p,_.hasText,y),I.classList.add("spotify-lyrics-line-enter"),I.style.setProperty("--spotify-lyrics-enter-delay",`${Math.min(j*28,280)}ms`),G.className="spotify-lyrics-line-text",!_.hasText)G.classList.add("spotify-lyrics-line-symbol");if(en(_.text))G.classList.add("spotify-lyrics-line-text-long");return G.textContent=_.displayText,I.appendChild(G),I.addEventListener("click",()=>{if(w=_.timeMs,k=Date.now()+Kn,d&&d.trackUri===c)d={...d,progressMs:_.timeMs,updatedAt:Date.now()},a.setPlayback(d);V(_.index,!0),e?.(_.timeMs)}),t.appendChild(I),{index:_.index,timeMs:_.timeMs,text:_.text,el:I,textEl:G}}),W(),d?.isPlaying)U()}function q(g){E(),t.className="spotify-lyrics-body spotify-lyrics-has-content";let z=document.createElement("div");z.className="spotify-lyrics-text spotify-lyrics-text-enter",z.textContent=g,t.appendChild(z)}function F(g,z,_,j){if(x(),u.cancel(),E(),c=g,t.innerHTML="",l=[],p=-1,j){t.className="spotify-lyrics-body";let G=document.createElement("div");G.className="spotify-lyrics-status",G.textContent="♪ Instrumental",t.appendChild(G);return}let I=ut(_);if(I.length>0){P(I);return}if(!z){t.className="spotify-lyrics-body";let G=document.createElement("div");G.className="spotify-lyrics-status",G.textContent="No lyrics available",t.appendChild(G);return}q(z)}function H(g){if(!g||g.trackUri!==c){d=null,a.setPlayback(null),w=null,k=0,x();return}if(w!==null)if(Math.abs(g.progressMs-w)<=Xn)w=null,k=0;else if(Date.now()<k)return;else w=null,k=0;if(d={trackUri:g.trackUri,progressMs:g.progressMs,durationMs:g.durationMs,isPlaying:g.isPlaying,updatedAt:Date.now()},a.setPlayback(d),W(),g.isPlaying)U();else x()}return{root:n,update:F,updatePlayback:H,setLoading:ie,setAutoScrollSuspended(g){if(u.suspend(g)&&!g&&l.length)V(p,!0)},setBlurEnabled(g){if(y===g)return;y=g,M(),b()},clear:se,destroy(){x(),u.destroy(),E(),n.remove()}}}var Ut="right",Zn='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>',Qn='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>',cn='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92s2.92-1.31 2.92-2.92-1.31-2.92-2.92-2.92z"/></svg>',Jn='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7zM19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7h-2v7z"/></svg>';function ei(e){try{return new Date(e).toLocaleString(void 0,{month:"short",day:"numeric",hour:"numeric",minute:"2-digit"})}catch{return""}}function pn(e,n){let r=new Map,t=new Map,c=new Map,l=null,a=null,u=null,d=null,p=null,y=null,h=null,L=null,w=null,k=null,E=null,x=null,U=null;function b(v){let S=r.get(v);if(!S)return null;let O=t.get(v)??0;return S.get(O)??null}function M(v){let S=r.get(v);return!!S&&S.size>0}function V(v){if(!M(v))return;let S=c.get(v);if(!S||!S.isConnected){let O=e.dom.findMessageElement(v);if(!O)return;let D=e.dom.inject(O,`<button type="button" class="spotify-song-badge" aria-label="Song that was playing" title="Song that was playing">${Zn}</button>`,"beforeend");D.classList.add("spotify-song-badge-wrap"),D.dataset.corner=Ut,D.addEventListener("click",(B)=>{B.stopPropagation(),B.preventDefault(),G(v,D)}),c.set(v,D),S=D}W(v)}function W(v){let S=c.get(v);if(!S)return;S.style.display=b(v)?"":"none"}function se(){for(let{messageId:v}of e.dom.listMessageElements())if(M(v))V(v)}function ie(){if(a)return;a=document.createElement("div"),a.className="spotify-song-pop";let v=document.createElement("div");v.className="spotify-song-pop-header",v.textContent="Playing when generated";let S=document.createElement("div");S.className="spotify-song-pop-body",u=je("spotify-song-pop-art"),u.el.style.display="";let O=document.createElement("div");O.className="spotify-song-pop-info",d=document.createElement("div"),d.className="spotify-song-pop-track",p=document.createElement("div"),p.className="spotify-song-pop-artist",y=document.createElement("div"),y.className="spotify-song-pop-album",h=document.createElement("div"),h.className="spotify-song-pop-when",O.appendChild(d),O.appendChild(p),O.appendChild(y),O.appendChild(h),S.appendChild(u.el),S.appendChild(O);let D=document.createElement("div");D.className="spotify-song-pop-actions",L=document.createElement("button"),L.type="button",L.className="spotify-song-pop-btn spotify-song-pop-btn-primary",L.innerHTML=`${Qn}<span>Play</span>`,L.addEventListener("click",(B)=>{B.stopPropagation();let Q=E?b(E):null;if(Q?.trackUri)n({type:"play",trackUri:Q.trackUri});I()}),w=document.createElement("button"),w.type="button",w.className="spotify-song-pop-btn",P(),w.addEventListener("click",(B)=>{B.stopPropagation();let Q=E?b(E):null;if(Q)q(Q)}),k=document.createElement("a"),k.className="spotify-song-pop-btn spotify-song-pop-link",k.target="_blank",k.rel="noopener noreferrer",k.innerHTML=`${Jn}<span>Open</span>`,k.addEventListener("click",(B)=>B.stopPropagation()),D.appendChild(L),D.appendChild(w),D.appendChild(k),a.appendChild(v),a.appendChild(S),a.appendChild(D),a.addEventListener("click",(B)=>B.stopPropagation()),document.body.appendChild(a)}function P(){if(!w)return;w.innerHTML=`${cn}<span>Share</span>`}async function q(v){let S=`${v.trackName} — ${v.artistName}`,O=navigator;if(typeof O.share==="function")try{await O.share({title:v.trackName,text:S,url:v.spotifyUrl});return}catch{}try{if(await navigator.clipboard?.writeText(v.spotifyUrl),w){if(w.innerHTML=`${cn}<span>Copied!</span>`,U)clearTimeout(U);U=setTimeout(P,1400)}}catch{}}function F(v){if(ie(),P(),!v){if(u?.setUrl(null),d)d.textContent="No track playing";if(p)p.textContent="";if(y)y.textContent="Nothing was playing when this version was written.";if(h)h.textContent="";if(L)L.style.display="none";if(w)w.style.display="none";if(k)k.style.display="none";return}if(u?.setUrl(Ye(v.albumArtUrl,v.trackUri)),d)d.textContent=v.trackName;if(p)p.textContent=v.artistName;if(y)y.textContent=v.albumName;if(h)h.textContent=ei(v.capturedAt);if(L)L.style.display="";if(w)w.style.display="";if(k)k.style.display="",k.href=v.spotifyUrl}function H(v){if(!a)return;let S=v.getBoundingClientRect(),O=a.offsetWidth||280,D=a.offsetHeight||200,B=8,Q=S.top-D-8,ee="bottom";if(Q<B)Q=S.bottom+8,ee="top";let ce=S.right-O,Re=Ut==="right"?"right":"left";if(Ut==="left")ce=S.left;ce=Math.max(B,Math.min(ce,window.innerWidth-O-B)),Q=Math.max(B,Math.min(Q,window.innerHeight-D-B)),a.style.left=`${ce}px`,a.style.top=`${Q}px`,a.style.transformOrigin=`${ee} ${Re}`}function g(v){let S=v.target;if(!(S instanceof Node))return;if(a&&a.contains(S))return;if(x&&x.contains(S))return;I()}function z(){I()}function _(v){if(v.key==="Escape")I()}function j(v,S){F(b(v)),E=v,x=S,a.classList.add("open"),H(S),setTimeout(()=>{document.addEventListener("click",g,!0),window.addEventListener("scroll",z,!0),window.addEventListener("resize",z,!0),document.addEventListener("keydown",_,!0)},0)}function I(){if(!a||!E)return;a.classList.remove("open"),E=null,x=null,document.removeEventListener("click",g,!0),window.removeEventListener("scroll",z,!0),window.removeEventListener("resize",z,!0),document.removeEventListener("keydown",_,!0)}function G(v,S){if(E===v)I();else{if(E)I();j(v,S)}}function ge(v,S){if(v!==l)J();l=v;let O=new Set(S.map((D)=>D.messageId));for(let D of[...r.keys()])if(!O.has(D))ve(D);for(let D of S){let B=new Map;for(let[Q,ee]of Object.entries(D.bySwipe))B.set(Number(Q),ee);r.set(D.messageId,B),t.set(D.messageId,D.activeSwipe),V(D.messageId)}}function he(v,S,O,D){if(l&&v!==l)return;l=v;let B=r.get(S)??new Map;if(B.set(O,D),r.set(S,B),t.set(S,O),V(S),E===S)F(b(S))}function Z(v,S){if(t.set(v,S),W(v),E===v){let O=b(v);if(O)F(O);else I()}}function ve(v){if(E===v)I();r.delete(v),t.delete(v);let S=c.get(v);if(S){try{e.dom.uninject(S)}catch{}c.delete(v)}}function J(){I();for(let v of c.values())try{e.dom.uninject(v)}catch{}c.clear(),r.clear(),t.clear(),l=null}function A(){if(J(),U)clearTimeout(U);u?.destroy(),a?.remove(),a=null}return{setChatSongs:ge,setMessageSong:he,decorate:V,decorateMounted:se,setActiveSwipe:Z,removeMessage:ve,reset:J,destroy:A}}var ti={width:320,height:196},ni={width:348,height:520};var mn={width:300,height:420};function un({desktopPopout:e,hasPlayback:n,viewportHeight:r,viewportWidth:t}){let c=n?ni:ti;if(e)return{...c};if(!n)return{width:Math.max(280,Math.min(c.width,t-24)),height:c.height};return{width:Math.max(mn.width,Math.min(c.width,t-24)),height:Math.max(mn.height,Math.min(c.height,r-24))}}var ii='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.586 14.424a.622.622 0 01-.857.207c-2.348-1.435-5.304-1.76-8.785-.964a.622.622 0 11-.277-1.215c3.809-.87 7.076-.496 9.712 1.115a.623.623 0 01.207.857zm1.224-2.719a.78.78 0 01-1.072.257c-2.687-1.652-6.785-2.131-9.965-1.166a.78.78 0 01-.973-.517.781.781 0 01.517-.972c3.632-1.102 8.147-.568 11.236 1.327a.78.78 0 01.257 1.071zm.105-2.835C14.692 8.95 9.375 8.775 6.297 9.71a.936.936 0 11-.543-1.791c3.532-1.072 9.404-.865 13.115 1.338a.936.936 0 01-.954 1.613z"/></svg>',oi='<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>',ri=[1,0,6],si=1600,ai=2200,li=1200,di=4200;function ci(e){if(!e)return 0;let n=e.match(/\d+/);return n?Number(n[0]):0}function pi(e,n){let r=e.split(".");for(let t=0;t<n.length;t+=1){let c=ci(r[t]),l=n[t];if(c>l)return!0;if(c<l)return!1}return!0}async function mi(){try{let e=await fetch("/api/v1/system/info",{credentials:"same-origin"});if(!e.ok)return!0;let n=await e.json(),r=typeof n?.backend?.version==="string"?n.backend.version:null;return r?pi(r,ri):!0}catch{return!0}}function ui(e){if(typeof e.deferReady!=="function"||typeof e.ready!=="function")return{dispose(){},release(){}};e.deferReady();let n=mi(),r=!1,t=!1;return{dispose(){r=!0},release(){if(r||t)return;t=!0,n.then((c)=>{if(!r&&c)e.ready()})}}}function fn(e){let n=ui(e),r=[],t="__TAURI_INTERNALS__"in window&&new URLSearchParams(window.location.search).has("desktopWidgetExtension"),c=e.dom.addStyle(Gt);r.push(c);let l=null,a=!1,u={clientId:"",hasSecret:!1,hasLastfmKey:!1,callbackUrl:void 0,promptAudioPreviewEnabled:!1},d=null,p=null,y=null,h={small:36,medium:48,large:64},L={small:112,medium:128,large:144},w=24,k=128,E=112,x=192,U="spotify-controls-widget-prefs";function b(i){return i==="modern"?L:h}function M(i){return i==="modern"?{min:E,max:x}:{min:w,max:k}}function V(i,o){let{min:m,max:T}=M(o);return Math.max(m,Math.min(i,T))}function W(i){return i==="small"||i==="medium"||i==="large"||i==="custom"}function se(i,o){let m=b(o);if(i===m.small)return"small";if(i===m.large)return"large";if(i!==m.medium)return"custom";return"medium"}function ie(i){let o=i?.miniPlayerStyle==="modern"?"modern":"default",m=b(o),T=W(i?.sizeMode)?i.sizeMode:void 0,Y=typeof i?.size==="number"?V(i.size,o):m.medium;if(T&&T!=="custom")Y=m[T];else if(!T)T=se(Y,o);return{size:Y,shape:i?.shape==="squircle"?"squircle":"circle",sizeMode:T,miniPlayerStyle:o,lyricsBlur:i?.lyricsBlur!==!1,x:typeof i?.x==="number"?i.x:void 0,y:typeof i?.y==="number"?i.y:void 0}}let P=48,q="circle",F="medium",H="default",g=!0,z,_;try{let i=ie(JSON.parse(localStorage.getItem(U)||"{}"));P=i.size,q=i.shape,F=i.sizeMode,H=i.miniPlayerStyle,g=i.lyricsBlur!==!1,z=i.x,_=i.y}catch{}let j=null;function I(){let i=j??K.getPosition(),o={size:P,shape:q,sizeMode:F,miniPlayerStyle:H,lyricsBlur:g,x:i.x,y:i.y};localStorage.setItem(U,JSON.stringify(o)),A({type:"save_widget_prefs",prefs:o})}let G=null;function ge(i){if(j=i,G)clearTimeout(G);G=setTimeout(I,500)}function he(i=Date.now()){if(d&&i>d.expiresAt)d=null;if(p&&i>p.expiresAt)p=null;if(y&&i>y.expiresAt)y=null}function Z(i,o=Date.now()){let m=i.isPlaying?Math.max(0,o-i.committedAt):0;return Math.min(i.positionMs+m,i.durationMs||1/0)}function ve(i,o=Date.now()){let m=i;if(p)if(m.volume!==null&&Math.abs(m.volume-p.percent)<=1)p=null;else if(o<=p.expiresAt)m={...m,volume:p.percent};else p=null;if(d)if(d.trackUri&&m.trackUri!==d.trackUri)d=null;else{let T=Math.round(Math.min(Z(d,o),m.durationMs||d.durationMs||1/0));if(Math.abs(m.progressMs-T)<=ai)d=null;else if(o<=d.expiresAt)m={...m,progressMs:T};else d=null}return m}function J(i){let o=Date.now();if(he(o),!i){if(y&&l)return ve(l,o);return null}if(y){if(!y.trackUri||i.trackUri!==y.trackUri||o>y.expiresAt)y=null}return ve(i,o)}function A(i){let o=i,m=Date.now();switch(o.type){case"seek":d={committedAt:m,durationMs:l?.durationMs??o.positionMs,expiresAt:m+si,isPlaying:l?.isPlaying??!1,positionMs:o.positionMs,trackUri:l?.trackUri??null};break;case"set_volume":p={expiresAt:m+li,percent:o.percent};break;case"next":case"previous":y={expiresAt:m+di,trackUri:l?.trackUri??null};break}e.sendToBackend(o)}let v=null,S=0,O=null,D=new Map,B=48;function Q(){if(O)clearTimeout(O),O=null}function ee(){Q(),S+=1,A({type:"album_colors",colors:null})}function ce(i,o){D.delete(i),D.set(i,o);while(D.size>B){let m=D.keys().next().value;if(!m)break;D.delete(m)}}function Re(i=1800){Q(),O=setTimeout(()=>{O=null,ee()},i)}function me(i){return new Promise((o)=>{let m=new Image;m.crossOrigin="anonymous",m.onload=()=>{try{let T=document.createElement("canvas"),Y=32;T.width=32,T.height=32;let le=T.getContext("2d");if(!le){o(null);return}le.drawImage(m,0,0,32,32);let rt=le.getImageData(0,0,32,32).data,nt=0,wt=0,lt=0.5,Ht=-1,Ot=0,Dt=0,Bt=0,Et=0;for(let gt=0;gt<rt.length;gt+=4){let Ft=rt[gt],$t=rt[gt+1],Yt=rt[gt+2];Ot+=Ft,Dt+=$t,Bt+=Yt,Et++;let ht=Ft/255,dt=$t/255,vt=Yt/255,st=Math.max(ht,dt,vt),bt=Math.min(ht,dt,vt),Pt=(st+bt)/2,Ct=0,Nt=0;if(st!==bt){let xt=st-bt;if(Nt=Pt>0.5?xt/(2-st-bt):xt/(st+bt),st===ht)Ct=((dt-vt)/xt+(dt<vt?6:0))/6;else if(st===dt)Ct=((vt-ht)/xt+2)/6;else Ct=((ht-dt)/xt+4)/6}let jt=Nt*(1-Math.abs(Pt-0.5)*1.6);if(jt>Ht)Ht=jt,nt=Ct,wt=Nt,lt=Pt}let qt=Math.round(Ot/Et),Vt=Math.round(Dt/Et),Wt=Math.round(Bt/Et),Cn=0.299*qt+0.587*Vt+0.114*Wt;o({dominant:{r:qt,g:Vt,b:Wt},dominantHsl:{h:Math.round(nt*360),s:Math.round(wt*100),l:Math.round(lt*100)},isLight:Cn>152})}catch{o(null)}},m.onerror=()=>o(null),m.src=i})}let Ce=e.ui.mount("settings_extensions"),Le=Xt(A,()=>window.location.origin,async(i)=>{if(i){if(!(await e.permissions.getGranted()).includes("interceptor"))try{if(!(await e.permissions.request(["interceptor"],{reason:"Spotify Controls needs the Interceptor permission to attach the current track's preview audio to eligible multimodal model requests."})).includes("interceptor"))return!1}catch{return!1}}return A({type:"set_prompt_audio_preview",enabled:i}),i});Ce.appendChild(Le.root),r.push(()=>Le.destroy());let de=null,pe=null,xe=null;function ze(){let{min:i,max:o}=M(H);if(de)de.textContent=H==="modern"?"Collapsed Modern Player Size (px)":"Custom Widget Size (px)";if(pe)pe.textContent=H==="modern"?"Controls the compact size of the modern player before it expands.":"Controls the floating widget size.";if(xe)xe.min=String(i),xe.max=String(o),xe.placeholder=H==="modern"?"e.g. 128":"e.g. 56",xe.value=F==="custom"?String(P):""}let ue=Le.root.querySelector(".spotify-settings-card-body");if(ue){let i=document.createElement("div");i.style.cssText="height:1px;background:var(--lumiverse-border);margin:4px 0",ue.appendChild(i);let o=document.createElement("label");o.className="spotify-settings-label",de=document.createElement("span"),o.appendChild(de),pe=document.createElement("div"),pe.style.cssText="font-size:0.8em;opacity:0.6;margin-top:2px";let m=document.createElement("div");m.className="spotify-settings-row";let T=document.createElement("input");T.className="spotify-input",T.type="number",T.style.width="80px",xe=T;let Y=document.createElement("button");Y.className="spotify-btn spotify-btn-primary",Y.textContent="Apply",Y.style.fontSize="0.85em",Y.style.padding="4px 12px",Y.addEventListener("click",()=>{let le=parseInt(T.value,10),{min:rt,max:nt}=M(H);if(isNaN(le)||le<rt||le>nt)return;F="custom",Te(le)}),m.appendChild(T),m.appendChild(Y),o.appendChild(m),o.appendChild(pe),ue.appendChild(o)}ze();let Me=null;function Ge(){if(Me)Me.checked=g}function Ve(){Ee.setBlurEnabled(g),te.setLyricsBlur(g),Ge()}if(ue){let i=document.createElement("div");i.style.cssText="height:1px;background:var(--lumiverse-border);margin:4px 0";let o=document.createElement("label");o.className="spotify-settings-check";let m=document.createElement("input");m.type="checkbox",m.checked=g,Me=m;let T=document.createElement("span");T.textContent="Lyrics blur",o.append(m,T);let Y=document.createElement("div");Y.style.cssText="font-size:0.8em;opacity:0.65;margin-top:4px",Y.textContent="Depth-blurs receding lyric lines and fades new lines in through a blur. Turn off for crisp text.";let le=document.createElement("div");le.append(o,Y),m.addEventListener("change",()=>{g=m.checked,Ve(),I()}),ue.append(i,le)}let fe=e.ui.registerDrawerTab({id:"spotify",title:"Spotify Controls",shortName:"Spotify",description:"Control Spotify playback, search for music, and view lyrics",keywords:["music","player","now playing","song","track","album","lyrics"],headerTitle:"Spotify",iconSvg:ii});r.push(()=>fe.destroy());let we=document.createElement("div");we.className="spotify-panel",fe.root.classList.add("spotify-tab-root"),fe.root.appendChild(we);function ke(){let i=fe.root.getBoundingClientRect().top,o=fe.root.parentElement?.getBoundingClientRect().bottom??window.innerHeight,m=window.visualViewport?.height??window.innerHeight,T=Math.min(o,m);fe.root.style.setProperty("--spotify-tab-height",`${Math.max(240,T-i-2)}px`)}ke();let Je=new ResizeObserver(ke);Je.observe(fe.root),window.addEventListener("resize",ke),r.push(()=>{Je.disconnect(),window.removeEventListener("resize",ke)});let He=Kt((i)=>{A({type:"seek",positionMs:i})}),Oe=Zt(A),Xe=Qt(A),Ee=dn((i)=>{A({type:"seek",positionMs:i})});we.appendChild(He.root),we.appendChild(Oe.root),we.appendChild(Xe.root),we.appendChild(Ee.root),r.push(()=>He.destroy(),()=>Oe.destroy(),()=>Xe.destroy(),()=>Ee.destroy());let We=null,K=e.ui.createFloatWidget({width:P,height:P,tooltip:"Spotify",chromeless:!0});r.push(()=>K.destroy());let X=document.createElement("div");X.className="spotify-float-widget";function Fe(){X.classList.remove("spotify-float-widget-mounted"),requestAnimationFrame(()=>{requestAnimationFrame(()=>{X.classList.add("spotify-float-widget-mounted")})})}let Pe=document.createElement("div");Pe.className="spotify-float-widget-legacy";let Ne=document.createElement("div");Ne.className="spotify-float-widget-icon",Ne.innerHTML=oi;let De=je("spotify-float-widget-art");De.el.style.display="none",Pe.appendChild(Ne),Pe.appendChild(De.el),X.appendChild(Pe);let oe=!1,Ie=12,Be=420,Ae=null,te=an(A,()=>fe.activate(),()=>it(!1));X.appendChild(te.root),K.root.appendChild(X),Fe(),Ve();function Ke(){return un({desktopPopout:t,hasPlayback:Boolean(l),viewportHeight:window.innerHeight,viewportWidth:window.innerWidth})}function et(i=oe){if(H==="modern")return i?Ke():{width:P,height:P};return{width:P,height:P}}function it(i){let o=oe;oe=i&&H==="modern",N.hide(),Ue(et(oe)),te.setExpanded(oe),_e({delaySizeRequest:o&&!oe}),requestAnimationFrame(()=>Ue(et()))}function $e(i,o=!1){if(Ae)clearTimeout(Ae),Ae=null;let m=()=>{Ae=null,K.setSize(i.width,i.height)};if(o)Ae=setTimeout(m,Be);else m()}function _e({delaySizeRequest:i=!1}={}){let o=H==="modern"&&oe?"pan-y":"none",m=et();if(K.root.style.touchAction=o,K.root.style.transition="width 420ms cubic-bezier(0.22, 1, 0.36, 1), height 420ms cubic-bezier(0.22, 1, 0.36, 1)",X.style.transition="width 420ms cubic-bezier(0.22, 1, 0.36, 1), height 420ms cubic-bezier(0.22, 1, 0.36, 1), border-radius 420ms cubic-bezier(0.22, 1, 0.36, 1)",X.style.touchAction=o,te.setCollapsedSize(P),H==="modern"){X.classList.add("spotify-float-widget-modern-mode"),Pe.style.display="none",te.root.style.display="block",K.root.style.width=`${m.width}px`,K.root.style.height=`${m.height}px`,X.style.width=`${m.width}px`,X.style.height=`${m.height}px`,X.style.borderRadius=oe?"30px":`${Math.max(18,Math.round(P*0.28))}px`,$e(m,i);return}X.classList.remove("spotify-float-widget-modern-mode"),Pe.style.display="flex",te.root.style.display="none";let T=q==="circle"?"50%":"22%";K.root.style.width=`${P}px`,K.root.style.height=`${P}px`,X.style.width=`${P}px`,X.style.height=`${P}px`,X.style.borderRadius=T;let Y=Math.round(P*0.5),le=Ne.querySelector("svg");if(le)le.style.width=`${Y}px`,le.style.height=`${Y}px`;$e(m)}if(_e(),r.push(()=>{if(Ae)clearTimeout(Ae)}),K.onDragEnd((i)=>ge(i)),z!==void 0&&_!==void 0)K.moveTo(z,_);function Ue(i=et()){let o=K.getPosition(),m=window.innerWidth-i.width-Ie,T=window.innerHeight-i.height-Ie,Y=Math.max(Ie,Math.min(o.x,m)),le=Math.max(Ie,Math.min(o.y,T));if(Y!==o.x||le!==o.y)K.moveTo(Y,le)}function f(){if(H==="modern"&&oe){_e(),requestAnimationFrame(()=>Ue(et()));return}Ue()}window.addEventListener("resize",f),r.push(()=>window.removeEventListener("resize",f));let N=rn(A,()=>fe.activate(),()=>{let i=K.root.getBoundingClientRect();return{x:i.left,y:i.top,w:i.width,h:i.height}});N.setStyle("default"),r.push(()=>N.destroy()),r.push(()=>te.destroy());function ae(){if(K.root.style.display=a?"":"none",!a)N.hide(),oe=!1,te.setExpanded(!1)}ae(),Oe.onVolumeChange((i)=>N.setVolume(i)),N.onVolumeChange((i)=>Oe.setVolume(i));let ne=!1,s={x:0,y:0},C=5;X.addEventListener("pointerdown",(i)=>{if(ne=!1,s={x:i.clientX,y:i.clientY},N.isOpen()){let o=null,m=()=>{if(ne&&o===null)o=requestAnimationFrame(()=>{N.reposition(),o=null})},T=()=>{if(document.removeEventListener("pointermove",m),o!==null)cancelAnimationFrame(o)};document.addEventListener("pointermove",m),document.addEventListener("pointerup",T,{once:!0})}}),X.addEventListener("pointermove",(i)=>{if(!ne){let o=Math.abs(i.clientX-s.x),m=Math.abs(i.clientY-s.y);if(o>C||m>C)ne=!0}}),X.addEventListener("pointerup",()=>{requestAnimationFrame(()=>Ue())}),X.addEventListener("click",(i)=>{if(ne){i.stopPropagation(),ne=!1;return}if(i.stopPropagation(),H==="modern"){if(!oe)it(!0);return}N.toggle()});let R=0;async function re(i,o){let m=[{key:"small",label:"Small",active:F==="small"},{key:"medium",label:"Medium",active:F==="medium"},{key:"large",label:"Large",active:F==="large"},{key:"custom",label:"Custom…",active:F==="custom"}];if(H!=="modern")m.push({key:"div",label:"",type:"divider"},{key:"circle",label:"Circle",active:q==="circle"},{key:"squircle",label:"Squircle",active:q==="squircle"});m.push({key:H==="modern"?"div":"div2",label:"",type:"divider"},{key:"mini-default",label:"Default Mini Player",active:H==="default"},{key:"mini-modern",label:"Modern Lyrics Mini Player",active:H==="modern"}),R+=1,N.setUiSuspended(!0),te.setAutoScrollSuspended(!0),Ee.setAutoScrollSuspended(!0);let T;try{({selectedKey:T}=await e.ui.showContextMenu({position:{x:i,y:o},items:m}))}finally{if(R=Math.max(0,R-1),R===0)N.setUiSuspended(!1),te.setAutoScrollSuspended(!1),Ee.setAutoScrollSuspended(!1)}if(!T)return;if(T==="small"||T==="medium"||T==="large")F=T,Te(b(H)[T]);else if(T==="custom")e.events.emit("open-settings",{view:"extensions"});else if(T==="circle"||T==="squircle")q=T,I(),_e();else if(T==="mini-default"||T==="mini-modern"){H=T==="mini-modern"?"modern":"default";let Y=b(H);if(F!=="custom")P=Y[F];else P=V(P,H);if(H!=="modern")oe=!1,te.setExpanded(!1);N.hide(),I(),ze(),_e(),Ue()}}let be=null,Ze=!1,tt={x:0,y:0};X.addEventListener("touchstart",(i)=>{Ze=!1;let o=i.touches[0];tt={x:o.clientX,y:o.clientY},be=setTimeout(()=>{Ze=!0,navigator.vibrate?.(50),re(o.clientX,o.clientY)},500)}),X.addEventListener("touchmove",(i)=>{if(!be)return;let o=i.touches[0];if(Math.abs(o.clientX-tt.x)>10||Math.abs(o.clientY-tt.y)>10)clearTimeout(be),be=null}),X.addEventListener("touchend",(i)=>{if(be)clearTimeout(be),be=null;if(Ze){Ze=!1;return}if(H==="modern"&&oe){ne=!1;return}if(!ne){if(i.cancelable)i.preventDefault();if(H==="modern"){if(!oe)it(!0)}else N.toggle()}ne=!1});function Te(i){N.hide(),oe=!1,te.setExpanded(!1);let o=K.getPosition();j=o,K.destroy(),P=V(i,H),ze(),I(),K=e.ui.createFloatWidget({width:P,height:P,tooltip:"Spotify",chromeless:!0}),_e(),K.root.appendChild(X),Fe(),ae(),K.moveTo(o.x,o.y),K.onDragEnd((m)=>ge(m)),Ue()}X.addEventListener("contextmenu",(i)=>{i.preventDefault(),i.stopPropagation(),re(i.clientX,i.clientY)});function Se(i){let o=Ye(i?.albumArtUrl??null,i?.trackUri);if(o)Ne.style.display="none",De.el.style.display="",De.setUrl(o);else Ne.style.display="",De.el.style.display="none",De.setUrl(null);te.update(i,a)}let Qe=e.messages.registerTagInterceptor({tagName:"spotify-search"},(i)=>{let o=i.attrs.query;if(!o)return;A({type:"search",query:o})});r.push(Qe);let qe=pn(e,A);r.push(()=>qe.destroy());function at(i){if(i)A({type:"get_chat_songs",chatId:i})}at(e.getActiveChat().chatId);let Mt=e.events.on("CHAT_SWITCHED",(i)=>{let o=i?.chatId??null;qe.reset(),at(o)});r.push(Mt);let gn=e.events.on("CHARACTER_MESSAGE_RENDERED",(i)=>{let o=i?.messageId;if(o)qe.decorate(o)});r.push(gn);let hn=e.events.on("MESSAGE_SWIPED",(i)=>{let o=i,m=o?.message?.id;if(m)qe.setActiveSwipe(m,o.message?.swipe_id??0)});r.push(hn);let vn=e.events.on("MESSAGE_DELETED",(i)=>{let o=i?.messageId;if(o)qe.removeMessage(o)});r.push(vn);let ot=null;function bn(i){if(ot)clearTimeout(ot),ot=null;if(!i||!i.isPlaying||i.durationMs<=0)return;let o=i.durationMs-i.progressMs;if(o<=0)return;ot=setTimeout(()=>{ot=null,A({type:"get_state"})},o+500)}r.push(()=>{if(ot)clearTimeout(ot)});let xn=e.onBackendMessage((i)=>{let o=i;switch(o.type){case"state":{let m=!!l;if(l=J(o.playbackState),a=o.connected,ae(),He.update(l,a),Oe.update(l,a),N.update(l,a),Ee.updatePlayback(l),Se(l),H==="modern"&&oe&&m!==!!l)_e(),requestAnimationFrame(()=>Ue());bn(l);let T=Ye(l?.albumArtUrl??null,l?.trackUri),Y=l?.albumArtKey||T;if(T!==v)if(v=T,T){Q();let nt=Y&&o.albumPalette?.artworkKey===Y?o.albumPalette.colors:D.get(Y||"");if(Y&&nt)ce(Y,nt),A({type:"album_colors",colors:nt,artworkKey:Y});else{let wt=++S;me(T).then((lt)=>{if(wt!==S||T!==v)return;if(lt){if(Y)ce(Y,lt);A({type:"album_colors",colors:lt,artworkKey:Y})}else if(!a)ee()})}}else if(a)Re();else ee();let le=l?.trackUri||null;if(le&&le!==We)We=le,Ee.setLoading(!0),te.setLyricsLoading(!0),A({type:"get_lyrics"});else if(!le&&We)We=null,Ee.clear(),te.updateLyrics(null,null,null,!1);break}case"config":u={clientId:o.clientId,hasSecret:o.hasSecret,hasLastfmKey:o.hasLastfmKey,callbackUrl:o.callbackUrl,promptAudioPreviewEnabled:o.promptAudioPreviewEnabled},Le.update(o.connected,o.clientId,o.hasSecret,o.hasLastfmKey,o.callbackUrl,o.promptAudioPreviewEnabled),a=o.connected,ae();break;case"search_results":Xe.setResults(o.results);break;case"devices":N.setDevices(o.devices);break;case"widget_prefs":{let m=ie(o.prefs);if(!m)break;let T=m.size!==P,Y=T||m.shape!==q||m.sizeMode!==F||m.miniPlayerStyle!==H||m.lyricsBlur!==g;if(q=m.shape,F=m.sizeMode,H=m.miniPlayerStyle,g=m.lyricsBlur!==!1,Ve(),ze(),H!=="modern")oe=!1,te.setExpanded(!1);if(Y)localStorage.setItem(U,JSON.stringify(m));if(T)requestAnimationFrame(()=>Te(m.size));else _e();if(typeof m.x==="number"&&typeof m.y==="number"){let le=K.getPosition();if(z===void 0&&_===void 0&&(le.x!==m.x||le.y!==m.y))K.moveTo(m.x,m.y),Ue()}break}case"auth_url":{let m=window.open(o.url,"spotify-auth","width=500,height=700,menubar=no,toolbar=no");if(!m||m.closed)window.location.href=o.url;break}case"connected":D.clear(),a=!0,ae(),A({type:"get_config"}),A({type:"get_state"});break;case"disconnected":D.clear(),d=null,p=null,y=null,a=!1,ae(),l=null,v=null,ee(),Le.update(!1,u.clientId,u.hasSecret,u.hasLastfmKey,u.callbackUrl,u.promptAudioPreviewEnabled),He.update(null,!1),Oe.update(null,!1),N.update(null,!1),te.update(null,!1),te.updateLyrics(null,null,null,!1),oe=!1,te.setExpanded(!1),Ee.clear(),Se(null);break;case"lyrics":if(o.trackUri&&o.trackUri!==We)break;Ee.update(o.trackUri,o.plainLyrics,o.syncedLyrics,o.instrumental),Ee.updatePlayback(l),te.updateLyrics(o.trackUri,o.plainLyrics,o.syncedLyrics,o.instrumental);break;case"chat_songs":qe.setChatSongs(o.chatId,o.entries);break;case"message_song":qe.setMessageSong(o.chatId,o.messageId,o.swipeId,o.snapshot);break;case"error":console.warn("[Spotify Controls]",o.message);break}});r.push(xn);let Rt=(i)=>{if(i.detail?.extensionId!==e.manifest.identifier)return;A({type:"get_config"}),A({type:"get_state"})};window.addEventListener("spindle:desktop-widget-returned",Rt),r.push(()=>window.removeEventListener("spindle:desktop-widget-returned",Rt));let wn=e.events.on("SPINDLE_PERMISSION_CHANGED",(i)=>{let o=i;if(o.extensionId!==e.manifest.identifier)return;if(o.permission!=="cors_proxy")return;if(o.granted)A({type:"get_config"}),A({type:"get_state"});else l=null,a=!1,D.clear(),ae(),ee(),He.update(null,!1),Oe.update(null,!1),N.update(null,!1),te.update(null,!1),oe=!1,te.setExpanded(!1),Se(null)});r.push(wn),e.permissions.getGranted().then((i)=>{let o=[];if(!i.includes("cors_proxy"))o.push("cors_proxy");if(!i.includes("generation"))o.push("generation");if(o.length===0)return;let m=o.includes("cors_proxy")?"Spotify Controls needs the CORS Proxy permission to communicate with the Spotify and Last.fm APIs. The Generation permission additionally lets it remember which song was playing when each reply was generated.":"Let Spotify Controls remember which song was playing when each reply was generated? This needs the Generation permission so it can capture the track the moment a reply begins.";e.ui.showConfirm({title:o.includes("cors_proxy")?"Permission Required":"Enable Song Memory?",message:m,variant:"info",confirmLabel:"Grant Permission",cancelLabel:"Not Now"}).then(({confirmed:T})=>{if(T)e.permissions.request(o)})}),A({type:"get_config"}),A({type:"get_state"}),A({type:"get_widget_prefs"});let En=setTimeout(()=>{A({type:"get_config"}),A({type:"get_state"})},2000);return r.push(()=>clearTimeout(En)),n.release(),()=>{n.dispose();for(let i of r)try{i()}catch{}}}function fi(e,n={}){let r={...n},t={componentId:`desktop-widget-detached-${crypto.randomUUID()}`,element:e instanceof HTMLElement?e:document.createElement("div"),update(c){r={...r,...c}},destroy(){},getValue(){if("checked"in r)return r.checked;return r.value},focus(){},blur(){}};return new Proxy(t,{get(c,l,a){if(l==="then")return;if(Reflect.has(c,l))return Reflect.get(c,l,a);return()=>{return}}})}function yn(e){let n=new Set,r=!1,t=()=>{let u=document.createElement("div");return n.add(u),u},c=(u)=>u instanceof Element&&[...n].some((d)=>d===u||d.contains(u)),l=new Proxy(e.components,{get(u,d,p){let y=Reflect.get(u,d,p);if(typeof y!=="function"||!String(d).startsWith("mount"))return y;return(h,L)=>{if(!r||c(h))return fi(h,L);return Reflect.apply(y,u,[h,L])}}}),a=new Proxy(e.ui,{get(u,d,p){if(d==="mount")return()=>t();if(d==="createFloatWidget"){let y=Reflect.get(u,d,p);return(...h)=>(r=!0,Reflect.apply(y,u,h))}if(d==="registerDrawerTab")return(y)=>({root:t(),tabId:y.id||"desktop-widget-detached",setTitle(){},setShortName(){},setBadge(){},activate(){},destroy(){},onActivate(){return()=>{}}});return Reflect.get(u,d,p)}});return new Proxy(e,{get(u,d,p){if(d==="components")return l;if(d==="ui")return a;return Reflect.get(u,d,p)}})}function io(e,n){return fn(yn(e))}export{io as setupWidget};
